...
import { newDept, getAllDept, deptSubjects, newSubject, newArticle, allArticles, showArticle, newComment, deleteArticle, likePost, editArticle } from '../controllers/ArticleController.js'
...
//! STATUS: OK
router.post('/:deptSlug/:subjectSlug/:articleSlug/edit', editArticle)
